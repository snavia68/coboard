...
import com.coboard.dto.mapper.IProyectoMapper;
...
public class ProyectoLogic implements IProyectoLogic {
    ...
    */
    ...
    public void validateProyecto(Proyecto proyecto) throws Exception {
        try {
            Set<ConstraintViolation<Proyecto>> constraintViolations = validator.validate(proyecto);
    ...
    public void deleteProyecto(Proyecto entity) throws Exception {
        ...
        if (entity.getIdproyecto() == null) {
            throw new ZMessManager().new EmptyFieldException("idproyecto");
        }

        List<Informacion> informacions = null;
        List<Proyectousuario> proyectousuarios = null;

        try {
            informacions = informacionDAO.findByProperty("proyecto.idproyecto",
                    entity.getIdproyecto());

            if (Utilities.validationsList(informacions) == true) {
                throw new ZMessManager().new DeletingException("informacions");
            }

            proyectousuarios = proyectousuarioDAO.findByProperty("proyecto.idproyecto",
                    entity.getIdproyecto());
            ...
            proyectoDAO.deleteById(entity.getIdproyecto());
    ...
    public List<ProyectoDTO> getDataProyecto() throws Exception {
        try {
            ...
            for (Proyecto proyectoTmp : proyecto) {
                ProyectoDTO proyectoDTO2 = proyectoMapper.proyectoToProyectoDTO(proyectoTmp);
    ...
    public Proyecto getProyecto(Integer idproyecto) throws Exception {
        ...
        try {
            entity = proyectoDAO.findById(idproyecto);
        } catch (Exception e) {
